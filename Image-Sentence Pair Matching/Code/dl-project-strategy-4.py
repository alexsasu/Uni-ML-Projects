...
from tensorflow.keras.layers import Input, Dense, Flatten, Embedding, Conv2D, MaxPooling2D, LSTM, Concatenate, Dropout, BatchNormalization
...
def load_image(image_id, images_dir):
    ...
    image = cv.cvtColor(image, cv.COLOR_BGR2GRAY) # We transform the image into grayscale
